...
//    );
  ...
  Future displayANotification() async {
    ...
    await flutterLocalNotificationsPlugin.show(id, 'Zalo Khuyến Mại',
        '1000 sản phẩm giá không đồng .', platformChannelSpecifics,
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: ListTile(
          dense: false,
          contentPadding:
              const EdgeInsets.only(top: 0.0, left: 5.0, right: 0.0),
          title: TextField(
